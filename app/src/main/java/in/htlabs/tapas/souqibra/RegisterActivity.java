 ...
 */
public class RegisterActivity extends ActionBarActivity implements  View.OnClickListener, View.OnTouchListener {
    ...
    private static final String REGISTER_URL = "http://www.htlabs.in/student/ibrasouq/register.php";
